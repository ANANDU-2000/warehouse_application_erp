...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: staff WIRE-2 COMPLETE; Users & Roles Backend Slice 1–2 (`GET`+`POST …/users`) PASS on `ops/dashboard-module` — ask before next.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/`/home`/`/staff/home`/activity/breakdown-more COMPARE · staff **WIRE-2a–2f** · Users **Slice 1 GET** · Users **Slice 2 POST create** |
| 🟡 Current | Users create **PASS** — ask before GET-by-id/profile **or** Subagent 4 satellite |
| ⬜ Pending | Users GET profile / PATCH / … · Users UI · pick Subagent 4 satellite — [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
| 3 | Users & Roles | 🟡 Backend Slice 1–2 GET+POST PASS | [`users_roles_backend_list_compare.md`](modules/users_roles_backend_list_compare.md) · [`users_roles_backend_create_compare.md`](modules/users_roles_backend_create_compare.md) |
...
**Unlocked.** Phase 3 platform PASS. Login + Splash COMPARE PASS. Staff `/staff/home` WIRE-2 **COMPLETE**. Users & Roles Backend Slice 1–2 (`GET`+`POST …/users`) **PASS**. Next: ask GET-by-id **or** Subagent 4 satellite.
...
**4.2 / 4.5 note:** Staff WIRE-2a–2f COMPLETE (`ops/dashboard-module`). Users `GET`+`POST …/users` PASS — compare MDs. Ask before GET profile or one Subagent 4 satellite ([`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md)). Users UI blocked. Owner routes + Splash COMPARE PASS.
