...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: **`/home/breakdown-more` COMPARE PASS** on `ops/dashboard-module` — ask before staff WIRE-2.

### Task board (Dashboard `/home/breakdown-more`)

| State | Step |
|---|---|
| ✅ Completed | Login COMPARE · Splash COMPARE · `/home` COMPARE · `/staff/home` COMPARE · `/home/activity` COMPARE · `/home/breakdown-more` SCAFFOLD → **COMPARE** |
| 🟡 Current | `/home/breakdown-more` COMPARE **PASS** — ask before staff WIRE-2 |
...
| 2 | Dashboard | 🟡 `/home`+activity+breakdown COMPARE · staff WIRE-2 next (ask) | [`home_breakdown_compare.md`](modules/home_breakdown_compare.md) |
...
**Unlocked.** Phase 3 platform PASS. Login + Splash COMPARE PASS. Dashboard `/home/breakdown-more` Step 7 **COMPARE PASS** — ask before staff WIRE-2.
...
**4.2 / 4.5 note:** `/home/breakdown-more` COMPARE PASS (`ops/dashboard-module`). Ask before staff WIRE-2. Users & Roles UI blocked (backend). `/home` + `/staff/home` + `/home/activity` + Splash COMPARE PASS.
...
---
*Last updated: 2026-07-18 — `/home/breakdown-more` COMPARE PASS (`ops/dashboard-module`); ask before staff WIRE-2.*
