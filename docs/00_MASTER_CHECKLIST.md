...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: **`/home/activity` WIRE** on `ops/dashboard-module` — STOP before STATES.

### Task board (Dashboard `/home/activity`)

| State | Step |
|---|---|
| ✅ Completed | Login COMPARE · Splash COMPARE · `/home` COMPARE · `/staff/home` COMPARE · `/home/activity` SCAFFOLD · LAYOUT · FIELDS · BUTTONS · **WIRE** |
| 🟡 Current | `/home/activity` WIRE **PASS** — next STATES |
| ⬜ Pending | `/home/activity` STATES → COMPARE · then `/home/breakdown-more` · staff WIRE-2 · Users & Roles (backend blocked) |
...
| 2 | Dashboard | 🟡 `/home`+`/staff/home` COMPARE · `/home/activity` WIRE | [`home_activity_wire_compare.md`](modules/home_activity_wire_compare.md) |
...
**Unlocked.** Phase 3 platform PASS. Login + Splash COMPARE PASS. Dashboard `/home/activity` Step 5 **WIRE** — next STATES.
...
**4.2 / 4.5 note:** `/home/activity` WIRE PASS (`ops/dashboard-module`). Next STATES. Users & Roles UI blocked (backend). `/home` + `/staff/home` + Splash COMPARE PASS.
...
---
*Last updated: 2026-07-18 — `/home/activity` WIRE PASS (`ops/dashboard-module`); STOP before STATES.*
