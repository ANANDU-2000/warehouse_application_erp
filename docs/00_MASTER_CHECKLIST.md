...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: Subagent 4 **Staff search COMPARE PASS** on `ops/dashboard-module` — ask before next stub.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/home/staff COMPARE · WIRE-2a–2f · Users COMPARE · Activity WIRE · Notifications COMPARE · Staff search **SCAFFOLD→COMPARE** |
...
| 2 | Dashboard | 🟡 WIRE-2 · Staff search COMPARE | [`staff_search_compare.md`](modules/staff_search_compare.md) · [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
**Unlocked.** Phase 3 platform PASS. Subagent 4: `/staff/search` **COMPARE PASS**. Next: ask before next stub.
...
**4.2 / 4.5 note:** Subagent 4 Staff search COMPARE PASS — [`staff_search_compare.md`](modules/staff_search_compare.md). Ask before next stub. Settings hub skipped (implement locked).
...
---
*Last updated: 2026-07-19 — Staff search COMPARE PASS ([`staff_search_compare.md`](modules/staff_search_compare.md)); ask before next Subagent 4 stub.*
