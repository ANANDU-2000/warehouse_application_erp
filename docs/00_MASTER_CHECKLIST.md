...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: Subagent 4 **Staff activity STATES** on `ops/dashboard-module` — ask before COMPARE.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/home/staff COMPARE · WIRE-2a–2f · Users COMPARE · Activity WIRE · Notifications COMPARE · Staff search/items/stock/purchase-history/low-stock COMPARE · Staff activity **SCAFFOLD→STATES** |
| 🟡 Current | `/staff/activity` **STATES PASS** — ask before COMPARE |
| ⬜ Pending | Staff activity COMPARE · other stubs — [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
| 2 | Dashboard | 🟡 WIRE-2 · Staff activity STATES | [`staff_activity_states_compare.md`](modules/staff_activity_states_compare.md) · [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
**Unlocked.** Phase 3 platform PASS. Subagent 4: `/staff/activity` **STATES PASS**. Next: ask before COMPARE.
...
**4.2 / 4.5 note:** Subagent 4 Staff activity STATES PASS — [`staff_activity_states_compare.md`](modules/staff_activity_states_compare.md). Ask before COMPARE. Settings hub skipped (implement locked).
...
---
*Last updated: 2026-07-19 — Staff activity STATES PASS ([`staff_activity_states_compare.md`](modules/staff_activity_states_compare.md)); ask before COMPARE.*
