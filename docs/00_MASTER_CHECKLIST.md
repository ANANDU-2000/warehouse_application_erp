...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: **`/home/breakdown-more` BUTTONS** on `ops/dashboard-module` — STOP before WIRE.

### Task board (Dashboard `/home/breakdown-more`)

| State | Step |
|---|---|
| ✅ Completed | Login COMPARE · Splash COMPARE · `/home` COMPARE · `/staff/home` COMPARE · `/home/activity` COMPARE · `/home/breakdown-more` SCAFFOLD · LAYOUT · FIELDS · **BUTTONS** |
| 🟡 Current | `/home/breakdown-more` BUTTONS **PASS** — next WIRE |
| ⬜ Pending | `/home/breakdown-more` WIRE → STATES → COMPARE · staff WIRE-2 · Users & Roles (backend blocked) |
...
| 2 | Dashboard | 🟡 activity COMPARE · `/home/breakdown-more` BUTTONS | [`home_breakdown_buttons_compare.md`](modules/home_breakdown_buttons_compare.md) |
...
**Unlocked.** Phase 3 platform PASS. Login + Splash COMPARE PASS. Dashboard `/home/breakdown-more` Step 4 **BUTTONS** — next WIRE.
...
**4.2 / 4.5 note:** `/home/breakdown-more` BUTTONS PASS (`ops/dashboard-module`). Next WIRE. Users & Roles UI blocked (backend). `/home` + `/staff/home` + `/home/activity` + Splash COMPARE PASS.
...
---
*Last updated: 2026-07-18 — `/home/breakdown-more` BUTTONS PASS (`ops/dashboard-module`); STOP before WIRE.*
