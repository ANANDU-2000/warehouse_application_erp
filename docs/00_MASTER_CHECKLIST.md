...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: Subagent 4 **Staff low-stock WIRE** on `ops/dashboard-module` — ask before STATES.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/home/staff COMPARE · WIRE-2a–2f · Users COMPARE · Activity WIRE · Notifications COMPARE · Staff search COMPARE · Staff items COMPARE · Staff stock COMPARE · Staff purchase-history COMPARE · Staff low-stock **SCAFFOLD→WIRE** |
| 🟡 Current | `/staff/low-stock` **WIRE PASS** — ask before STATES |
| ⬜ Pending | Staff low-stock STATES → COMPARE · other Subagent 4 stubs — [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
| 2 | Dashboard | 🟡 WIRE-2 · Staff low-stock WIRE | [`staff_low_stock_wire_compare.md`](modules/staff_low_stock_wire_compare.md) · [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
