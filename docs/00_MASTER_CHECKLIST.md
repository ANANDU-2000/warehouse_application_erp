...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: **Dashboard `/staff/home` WIRE** on `ops/dashboard-module` — next STATES after approve.

### Task board (Dashboard `/staff/home`)

| State | Step |
|---|---|
| ✅ Completed | SCAFFOLD · LAYOUT · FIELDS · BUTTONS · WIRE (scoped) |
| 🟡 Current | WIRE done — awaiting approve before STATES |
| ⬜ Pending | STATES → COMPARE |
| ⏸ Deferred | WIRE-2 bodies (warehouse stats, pending cards, shift, activity, notifications); Splash WIRE; Users & Roles implement |
...
| 2 | Dashboard | 🟡 `/staff/home` WIRE | [`staff_home_wire_compare.md`](modules/staff_home_wire_compare.md) — next STATES |
...
**4.2 / 4.5 note:** Dashboard `/staff/home` WIRE scoped (`ops/dashboard-module`). Next: STATES. Splash WIRE deferred. Owner `/home` COMPARE PASS.
...
---
*Last updated: 2026-07-18 — Dashboard `/staff/home` WIRE scoped (`ops/dashboard-module`); next = STATES after approve. Splash WIRE deferred.*
