...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: Subagent 4 **Staff search BUTTONS** on `ops/dashboard-module` — ask before WIRE.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/home/staff COMPARE · WIRE-2a–2f · Users COMPARE · Activity WIRE · Notifications COMPARE · Staff search **SCAFFOLD·LAYOUT·FIELDS·BUTTONS** |
| 🟡 Current | `/staff/search` **BUTTONS PASS** — ask before WIRE |
| ⬜ Pending | Staff search WIRE→COMPARE · other Subagent 4 stubs — [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
| 2 | Dashboard | 🟡 WIRE-2 · Staff search BUTTONS | [`staff_search_buttons_compare.md`](modules/staff_search_buttons_compare.md) · [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
**Unlocked.** Phase 3 platform PASS. Subagent 4: `/staff/search` **BUTTONS PASS**. Next: ask before WIRE.
...
**4.2 / 4.5 note:** Subagent 4 Staff search BUTTONS PASS — [`staff_search_buttons_compare.md`](modules/staff_search_buttons_compare.md). Ask before WIRE. Settings hub skipped (implement locked).
...
---
*Last updated: 2026-07-19 — Staff search BUTTONS PASS ([`staff_search_buttons_compare.md`](modules/staff_search_buttons_compare.md)); ask before WIRE.*
