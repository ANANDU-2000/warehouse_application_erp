...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: **`/home/activity` LAYOUT** on `ops/dashboard-module` — STOP before FIELDS.

### Task board (Dashboard `/home/activity`)

| State | Step |
|---|---|
| ✅ Completed | Login COMPARE · Splash COMPARE · `/home` COMPARE · `/staff/home` COMPARE · `/home/activity` SCAFFOLD · **LAYOUT** |
| 🟡 Current | `/home/activity` LAYOUT **PASS** — next FIELDS |
| ⬜ Pending | `/home/activity` FIELDS → BUTTONS → WIRE → STATES → COMPARE · then `/home/breakdown-more` · staff WIRE-2 · Users & Roles (backend blocked) |
...
| 2 | Dashboard | 🟡 `/home`+`/staff/home` COMPARE · `/home/activity` LAYOUT | [`home_activity_layout_compare.md`](modules/home_activity_layout_compare.md) |
...
**Unlocked.** Phase 3 platform PASS. Login + Splash COMPARE PASS. Dashboard `/home/activity` Step 2 **LAYOUT** — next FIELDS.
...
**4.2 / 4.5 note:** `/home/activity` LAYOUT PASS (`ops/dashboard-module`). Next FIELDS. Users & Roles UI blocked (backend). `/home` + `/staff/home` + Splash COMPARE PASS.
...
---
*Last updated: 2026-07-18 — `/home/activity` LAYOUT PASS (`ops/dashboard-module`); STOP before FIELDS.*
