...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: **`/home/breakdown-more` FIELDS** on `ops/dashboard-module` — STOP before BUTTONS.

### Task board (Dashboard `/home/breakdown-more`)

| State | Step |
|---|---|
| ✅ Completed | Login COMPARE · Splash COMPARE · `/home` COMPARE · `/staff/home` COMPARE · `/home/activity` COMPARE · `/home/breakdown-more` SCAFFOLD · LAYOUT · **FIELDS** |
| 🟡 Current | `/home/breakdown-more` FIELDS **PASS** — next BUTTONS |
| ⬜ Pending | `/home/breakdown-more` BUTTONS → WIRE → STATES → COMPARE · staff WIRE-2 · Users & Roles (backend blocked) |
...
| 2 | Dashboard | 🟡 activity COMPARE · `/home/breakdown-more` FIELDS | [`home_breakdown_fields_compare.md`](modules/home_breakdown_fields_compare.md) |
...
**Unlocked.** Phase 3 platform PASS. Login + Splash COMPARE PASS. Dashboard `/home/breakdown-more` Step 3 **FIELDS** — next BUTTONS.
...
**4.2 / 4.5 note:** `/home/breakdown-more` FIELDS PASS (`ops/dashboard-module`). Next BUTTONS. Users & Roles UI blocked (backend). `/home` + `/staff/home` + `/home/activity` + Splash COMPARE PASS.
...
---
*Last updated: 2026-07-18 — `/home/breakdown-more` FIELDS PASS (`ops/dashboard-module`); STOP before BUTTONS.*
