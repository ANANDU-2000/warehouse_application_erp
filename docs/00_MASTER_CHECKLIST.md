...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: **staff WIRE-2c** shift strip on `ops/dashboard-module` — STOP before WIRE-2d.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/`/home`/`/staff/home`/`/home/activity`/`/home/breakdown-more` COMPARE · staff WIRE-2a · WIRE-2b · **WIRE-2c** shift strip |
| 🟡 Current | staff WIRE-2c **PASS** — ask before WIRE-2d recent activity |
...
| 2 | Dashboard | 🟡 staff WIRE-2c PASS | [`staff_home_wire2c_compare.md`](modules/staff_home_wire2c_compare.md) |
...
**Unlocked.** Phase 3 platform PASS. Login + Splash COMPARE PASS. Dashboard staff **WIRE-2c** PASS — ask before WIRE-2d.
...
**4.2 / 4.5 note:** Staff WIRE-2c shift strip PASS (`ops/dashboard-module`). Ask before WIRE-2d. Users & Roles UI blocked (backend). Owner routes + Splash COMPARE PASS.
...
---
*Last updated: 2026-07-18 — staff WIRE-2c shift strip PASS (`ops/dashboard-module`); ask before WIRE-2d.*
