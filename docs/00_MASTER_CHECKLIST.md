...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: Subagent 4 **Staff stock SCAFFOLD** on `ops/dashboard-module` — ask before LAYOUT.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/home/staff COMPARE · WIRE-2a–2f · Users COMPARE · Activity WIRE · Notifications COMPARE · Staff search COMPARE · Staff items COMPARE · Staff stock **SCAFFOLD** |
| 🟡 Current | `/staff/stock` **SCAFFOLD PASS** — ask before LAYOUT |
| ⬜ Pending | Staff stock LAYOUT → COMPARE · other Subagent 4 stubs — [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
| 2 | Dashboard | 🟡 WIRE-2 · Staff stock SCAFFOLD | [`staff_stock_scaffold_compare.md`](modules/staff_stock_scaffold_compare.md) · [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
**Unlocked.** Phase 3 platform PASS. Subagent 4: `/staff/stock` **SCAFFOLD PASS**. Next: ask before LAYOUT.
...
**4.2 / 4.5 note:** Subagent 4 Staff stock SCAFFOLD PASS — [`staff_stock_scaffold_compare.md`](modules/staff_stock_scaffold_compare.md). Ask before LAYOUT. Settings hub skipped (implement locked).
...
---
*Last updated: 2026-07-19 — Staff stock SCAFFOLD PASS ([`staff_stock_scaffold_compare.md`](modules/staff_stock_scaffold_compare.md)); ask before LAYOUT.*
