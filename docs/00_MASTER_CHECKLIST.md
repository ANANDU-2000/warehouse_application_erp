...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: staff WIRE-2 COMPLETE; Users backend Slice 1–14 PASS; Users UI SCAFFOLD+LAYOUT PASS on `ops/dashboard-module` — ask before FIELDS.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/home/staff COMPARE · WIRE-2a–2f · Users backend **1–14** · Users UI **SCAFFOLD+LAYOUT** |
| 🟡 Current | Users `/settings/users` **LAYOUT PASS** — ask before **FIELDS** |
| ⬜ Pending | Users FIELDS→COMPARE · profile route · Subagent 4 — [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
| 3 | Users & Roles | 🟡 Backend 1–14 PASS · UI SCAFFOLD+LAYOUT PASS | [`users_management_layout_compare.md`](modules/users_management_layout_compare.md) · backend compares |
...
**Unlocked.** Phase 3 platform PASS. Login + Splash COMPARE PASS. Staff `/staff/home` WIRE-2 **COMPLETE**. Users backend Slice 1–14 **PASS**. Users UI **LAYOUT PASS**. Next: ask Users FIELDS **or** Subagent 4 satellite.
...
**4.2 / 4.5 note:** Staff WIRE-2a–2f COMPLETE (`ops/dashboard-module`). Users UI LAYOUT PASS — [`users_management_layout_compare.md`](modules/users_management_layout_compare.md). Ask before FIELDS or one Subagent 4 satellite ([`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md)). Owner routes + Splash COMPARE PASS.
...
---
*Last updated: 2026-07-19 — Users UI LAYOUT PASS ([`users_management_layout_compare.md`](modules/users_management_layout_compare.md)); ask before FIELDS.*
