...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: **staff WIRE-2f** pull-refresh on `ops/dashboard-module` — STOP before Users & Roles / Subagent 4.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/`/home`/`/staff/home`/`/home/activity`/`/home/breakdown-more` COMPARE · staff WIRE-2a–**2f** (incl. pull-refresh) |
| 🟡 Current | staff WIRE-2f **PASS** — ask before Users & Roles / Subagent 4 |
| ⬜ Pending | Users & Roles (backend blocked) |
...
| 2 | Dashboard | 🟡 staff WIRE-2f PASS | [`staff_home_wire2f_compare.md`](modules/staff_home_wire2f_compare.md) |
...
**Unlocked.** Phase 3 platform PASS. Login + Splash COMPARE PASS. Dashboard staff **WIRE-2f** PASS — ask before Users & Roles / Subagent 4.
...
**4.2 / 4.5 note:** Staff WIRE-2f pull-refresh PASS (`ops/dashboard-module`). Ask before Users & Roles / Subagent 4. Users & Roles UI blocked (backend). Owner routes + Splash COMPARE PASS.
...
---
*Last updated: 2026-07-18 — staff WIRE-2f pull-refresh PASS (`ops/dashboard-module`); ask before Users & Roles / Subagent 4.*
