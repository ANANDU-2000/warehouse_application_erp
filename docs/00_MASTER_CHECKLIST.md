...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: staff WIRE-2 COMPLETE; Users backend Slice 1–14 PASS; Users list UI **COMPARE PASS** on `ops/dashboard-module` — ask before profile SCAFFOLD or Subagent 4.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/home/staff COMPARE · WIRE-2a–2f · Users backend **1–14** · Users list UI **SCAFFOLD→COMPARE** |
| 🟡 Current | Users `/settings/users` **COMPARE PASS** — ask before **profile SCAFFOLD** or Subagent 4 |
| ⬜ Pending | Profile page loop · Subagent 4 — [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
| 3 | Users & Roles | 🟡 Backend 1–14 PASS · list UI COMPARE PASS | [`users_management_compare.md`](modules/users_management_compare.md) · backend compares |
...
**Unlocked.** Phase 3 platform PASS. Login + Splash COMPARE PASS. Staff `/staff/home` WIRE-2 **COMPLETE**. Users backend Slice 1–14 **PASS**. Users list UI **COMPARE PASS**. Next: ask profile SCAFFOLD **or** Subagent 4 satellite.
...
**4.2 / 4.5 note:** Staff WIRE-2a–2f COMPLETE (`ops/dashboard-module`). Users list UI COMPARE PASS — [`users_management_compare.md`](modules/users_management_compare.md). Ask before profile SCAFFOLD or one Subagent 4 satellite ([`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md)). Owner routes + Splash COMPARE PASS.
...
---
*Last updated: 2026-07-19 — Users list UI COMPARE PASS ([`users_management_compare.md`](modules/users_management_compare.md)); ask before profile SCAFFOLD or Subagent 4.*
