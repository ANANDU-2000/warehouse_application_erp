...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: staff WIRE-2 COMPLETE; Users COMPARE+Activity WIRE PASS; Subagent 4 **Notifications SCAFFOLD PASS** on `ops/dashboard-module` — ask before LAYOUT.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/home/staff COMPARE · WIRE-2a–2f · Users list+profile COMPARE · Activity WIRE · **Notifications SCAFFOLD** |
| 🟡 Current | `/notifications` **SCAFFOLD PASS** — ask before **LAYOUT** |
| ⬜ Pending | Notifications LAYOUT→COMPARE · other Subagent 4 stubs — [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
| 2 | Dashboard | 🟡 WIRE-2 DONE · Subagent 4 Notifications SCAFFOLD | [`notifications_scaffold_compare.md`](modules/notifications_scaffold_compare.md) · [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
**Unlocked.** Phase 3 platform PASS. Login + Splash COMPARE PASS. Staff `/staff/home` WIRE-2 **COMPLETE**. Users COMPARE + Activity WIRE PASS. Subagent 4: `/notifications` **SCAFFOLD PASS**. Next: ask notifications LAYOUT.
...
**4.2 / 4.5 note:** Staff WIRE-2a–2f COMPLETE (`ops/dashboard-module`). Subagent 4 Notifications SCAFFOLD PASS — [`notifications_scaffold_compare.md`](modules/notifications_scaffold_compare.md). Ask before LAYOUT. Settings `/staff/settings` skipped (implement locked).
...
---
*Last updated: 2026-07-19 — Notifications SCAFFOLD PASS ([`notifications_scaffold_compare.md`](modules/notifications_scaffold_compare.md)); ask before LAYOUT.*
