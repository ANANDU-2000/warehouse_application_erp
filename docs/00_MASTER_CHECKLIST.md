...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: Dashboard nest COMPLETE. **Catalog hub COMPARE PASS** on `ops/products-module` — ask before taxonomy SCAFFOLD.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/home/staff COMPARE · WIRE-2a–2f · Users COMPARE · Notifications COMPARE · Staff nest **COMPARE** · **Products Slice 1–7** · **Categories Slice 1–2** · Catalog hub **COMPARE** |
| 🟡 Current | Catalog hub **COMPARE PASS** — ask before `/catalog/taxonomy` SCAFFOLD — [`catalog_compare.md`](modules/catalog_compare.md) |
| ⬜ Pending | `/catalog/taxonomy` · other `/catalog/*` · Seq 7–8 / 11 purchase/receive/barcode — [`catalog_compare.md`](modules/catalog_compare.md) |
...
| 2 | Dashboard | 🟡 nest COMPLETE · Catalog COMPARE | [`catalog_compare.md`](modules/catalog_compare.md) · [`categories_backend_slice2.md`](modules/categories_backend_slice2.md) |
...
| 5 | Categories | 🟡 Backend Slice 1–2 · hub COMPARE PASS | [`catalog_compare.md`](modules/catalog_compare.md) · `docs/modules/categories.md` |
...
**Unlocked.** Phase 3 platform PASS. Dashboard nest COMPLETE. Catalog hub COMPARE PASS. Ask before `/catalog/taxonomy` SCAFFOLD.
...
**4.2 / 4.5 note:** Dashboard nest COMPLETE. Catalog hub COMPARE — [`catalog_compare.md`](modules/catalog_compare.md). Ask before taxonomy SCAFFOLD. Settings hub skipped (implement locked).
...
---
*Last updated: 2026-07-19 — Catalog hub COMPARE PASS ([`catalog_compare.md`](modules/catalog_compare.md)); ask before `/catalog/taxonomy` SCAFFOLD.*
