...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: Subagent 4 **Staff low-stock LAYOUT** on `ops/dashboard-module` — ask before FIELDS.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/home/staff COMPARE · WIRE-2a–2f · Users COMPARE · Activity WIRE · Notifications COMPARE · Staff search COMPARE · Staff items COMPARE · Staff stock COMPARE · Staff purchase-history COMPARE · Staff low-stock **SCAFFOLD→LAYOUT** |
| 🟡 Current | `/staff/low-stock` **LAYOUT PASS** — ask before FIELDS |
| ⬜ Pending | Staff low-stock FIELDS → COMPARE · other Subagent 4 stubs — [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
| 2 | Dashboard | 🟡 WIRE-2 · Staff low-stock LAYOUT | [`staff_low_stock_layout_compare.md`](modules/staff_low_stock_layout_compare.md) · [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
**Unlocked.** Phase 3 platform PASS. Subagent 4: `/staff/low-stock` **LAYOUT PASS**. Next: ask before FIELDS.
...
**4.2 / 4.5 note:** Subagent 4 Staff low-stock LAYOUT PASS — [`staff_low_stock_layout_compare.md`](modules/staff_low_stock_layout_compare.md). Ask before FIELDS. Settings hub skipped (implement locked).
...
---
*Last updated: 2026-07-19 — Staff low-stock LAYOUT PASS ([`staff_low_stock_layout_compare.md`](modules/staff_low_stock_layout_compare.md)); ask before FIELDS.*
