...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: **staff WIRE-2a** warehouse stats on `ops/dashboard-module` — STOP before WIRE-2b.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/`/home`/`/staff/home`/`/home/activity`/`/home/breakdown-more` COMPARE · staff **WIRE-2a** warehouse stats |
| 🟡 Current | staff WIRE-2a **PASS** — ask before WIRE-2b pending cards |
| ⬜ Pending | staff WIRE-2b → 2c → 2d · Users & Roles (backend blocked) |
...
| 2 | Dashboard | 🟡 breakdown COMPARE · staff WIRE-2a PASS | [`staff_home_wire2a_compare.md`](modules/staff_home_wire2a_compare.md) |
...
**Unlocked.** Phase 3 platform PASS. Login + Splash COMPARE PASS. Dashboard staff **WIRE-2a** PASS — ask before WIRE-2b.
...
**4.2 / 4.5 note:** Staff WIRE-2a warehouse stats PASS (`ops/dashboard-module`). Ask before WIRE-2b. Users & Roles UI blocked (backend). Owner routes + Splash COMPARE PASS.
...
---
*Last updated: 2026-07-18 — staff WIRE-2a warehouse stats PASS (`ops/dashboard-module`); ask before WIRE-2b.*
