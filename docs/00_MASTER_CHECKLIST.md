...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: Subagent 4 **Staff activity LAYOUT** on `ops/dashboard-module` — ask before FIELDS.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/home/staff COMPARE · WIRE-2a–2f · Users COMPARE · Activity WIRE · Notifications COMPARE · Staff search/items/stock/purchase-history/low-stock COMPARE · Staff activity **SCAFFOLD→LAYOUT** |
| 🟡 Current | `/staff/activity` **LAYOUT PASS** — ask before FIELDS |
| ⬜ Pending | Staff activity FIELDS → COMPARE · other stubs — [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
| 2 | Dashboard | 🟡 WIRE-2 · Staff activity LAYOUT | [`staff_activity_layout_compare.md`](modules/staff_activity_layout_compare.md) · [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
