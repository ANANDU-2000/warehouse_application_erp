...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: **`/home/activity` COMPARE PASS** on `ops/dashboard-module` — STOP before `/home/breakdown-more` SCAFFOLD.

### Task board (Dashboard nested routes)

| State | Step |
|---|---|
| ✅ Completed | Login COMPARE · Splash COMPARE · `/home` COMPARE · `/staff/home` COMPARE · `/home/activity` SCAFFOLD→**COMPARE** |
| 🟡 Current | `/home/activity` COMPARE **PASS** — next `/home/breakdown-more` SCAFFOLD |
| ⬜ Pending | `/home/breakdown-more` page loop · staff WIRE-2 · Users & Roles (backend blocked) |
| ⏸ Deferred | Pull-refresh / row detail on activity; Users & Roles UI; merge to `main`; Dashboard Subagent 4 |
...
| 2 | Dashboard | 🟡 `/home`+`/staff/home`+`/home/activity` COMPARE · next breakdown-more | [`home_activity_compare.md`](modules/home_activity_compare.md) |
...
**Unlocked.** Phase 3 platform PASS. Login + Splash COMPARE PASS. Dashboard `/home/activity` Step 7 **COMPARE PASS** — next `/home/breakdown-more` SCAFFOLD.
...
**4.2 / 4.5 note:** `/home/activity` COMPARE PASS (`ops/dashboard-module`). Next `/home/breakdown-more` SCAFFOLD. Users & Roles UI blocked (backend). `/home` + `/staff/home` + Splash COMPARE PASS.
...
---
*Last updated: 2026-07-18 — `/home/activity` COMPARE PASS (`ops/dashboard-module`); STOP before `/home/breakdown-more` SCAFFOLD.*
