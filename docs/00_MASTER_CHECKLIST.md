...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: staff WIRE-2 COMPLETE; Users backend Slice 1–14 PASS; Users list+profile COMPARE PASS; profile **Activity WIRE PASS** on `ops/dashboard-module` — ask before Subagent 4.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/home/staff COMPARE · WIRE-2a–2f · Users backend **1–14** · Users list+profile **COMPARE** · profile **Activity WIRE** |
| 🟡 Current | Profile Activity **WIRE PASS** — ask before **Subagent 4** |
| ⬜ Pending | Subagent 4 — [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
**Unlocked.** Phase 3 platform PASS. Login + Splash COMPARE PASS. Staff `/staff/home` WIRE-2 **COMPLETE**. Users backend Slice 1–14 **PASS**. Users list+profile **COMPARE PASS**. Profile Activity **WIRE PASS**. Next: ask Subagent 4 satellite.
...
**4.2 / 4.5 note:** Staff WIRE-2a–2f COMPLETE (`ops/dashboard-module`). Profile COMPARE + Activity WIRE PASS — [`user_profile_activity_wire_compare.md`](modules/user_profile_activity_wire_compare.md). Ask before one Subagent 4 satellite ([`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md)). Owner routes + Users list COMPARE PASS.
...
---
*Last updated: 2026-07-19 — User profile Activity WIRE PASS ([`user_profile_activity_wire_compare.md`](modules/user_profile_activity_wire_compare.md)); ask before Subagent 4.*
