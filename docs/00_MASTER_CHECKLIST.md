...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: staff WIRE-2 COMPLETE; Users backend Slice 1–14 PASS; Users list COMPARE PASS; profile **SCAFFOLD PASS** on `ops/dashboard-module` — ask before profile LAYOUT.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/home/staff COMPARE · WIRE-2a–2f · Users backend **1–14** · Users list **COMPARE** · profile **SCAFFOLD** |
| 🟡 Current | Profile `/settings/users/:userId` **SCAFFOLD PASS** — ask before **LAYOUT** |
| ⬜ Pending | Profile LAYOUT→COMPARE · Subagent 4 — [`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md) |
...
| 3 | Users & Roles | 🟡 Backend 1–14 PASS · list COMPARE · profile SCAFFOLD | [`user_profile_scaffold_compare.md`](modules/user_profile_scaffold_compare.md) · [`users_management_compare.md`](modules/users_management_compare.md) |
...
**Unlocked.** Phase 3 platform PASS. Login + Splash COMPARE PASS. Staff `/staff/home` WIRE-2 **COMPLETE**. Users backend Slice 1–14 **PASS**. Users list **COMPARE PASS**. Profile **SCAFFOLD PASS**. Next: ask profile LAYOUT **or** Subagent 4 satellite.
...
**4.2 / 4.5 note:** Staff WIRE-2a–2f COMPLETE (`ops/dashboard-module`). Profile SCAFFOLD PASS — [`user_profile_scaffold_compare.md`](modules/user_profile_scaffold_compare.md). Ask before LAYOUT or one Subagent 4 satellite ([`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md)). Owner routes + Users list COMPARE PASS.
...
---
*Last updated: 2026-07-19 — User profile SCAFFOLD PASS ([`user_profile_scaffold_compare.md`](modules/user_profile_scaffold_compare.md)); ask before LAYOUT.*
