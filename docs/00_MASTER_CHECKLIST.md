...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: **Dashboard `/staff/home` COMPARE PASS** on `ops/dashboard-module` — ask before next work.

### Task board (Dashboard `/staff/home`)

| State | Step |
|---|---|
| ✅ Completed | SCAFFOLD · LAYOUT · FIELDS · BUTTONS · WIRE (scoped) · STATES · **COMPARE** |
| 🟡 Current | Staff `/staff/home` route **PASS** — ask before next |
| ⬜ Pending (ask first) | Splash WIRE **or** staff WIRE-2 **or** Users & Roles |
| ⏸ Deferred | WIRE-2 bodies; merge `ops/dashboard-module` → `main`; full Dashboard module ✅ |
...
| 2 | Dashboard | 🟡 `/staff/home` COMPARE PASS | [`staff_home_compare.md`](modules/staff_home_compare.md) — ask before Splash WIRE / WIRE-2 / Users & Roles |
...
**Unlocked.** Phase 3 platform PASS. Login COMPARE PASS. Splash UI Step 4 BUTTONS done — next WIRE after review.
...
**4.2 / 4.5 note:** Dashboard `/staff/home` COMPARE PASS (`ops/dashboard-module`). Ask before Splash WIRE / WIRE-2 / Users & Roles. Owner `/home` COMPARE PASS.
...
---
*Last updated: 2026-07-18 — Dashboard `/staff/home` COMPARE PASS (`ops/dashboard-module`); ask before next work. Splash WIRE deferred.*
