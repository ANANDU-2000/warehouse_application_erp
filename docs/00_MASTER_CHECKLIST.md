...
**Phase 1 status: COMPLETE.** Phase 2: **COMPLETE** (live SQL verified — `docs/44`). Phase 3: **COMPLETE** (platform). Phase 4: Dashboard nest COMPLETE. **New-category LAYOUT PASS** on `ops/products-module` — ask before FIELDS.

### Task board (Dashboard staff WIRE-2)

| State | Step |
|---|---|
| ✅ Completed | Login/Splash/home/staff COMPARE · WIRE-2a–2f · Users COMPARE · Notifications COMPARE · Staff nest **COMPARE** · **Products Slice 1–7** · **Categories Slice 1–2** · Catalog hub **COMPARE** · taxonomy **COMPARE** · new-category SCAFFOLD→**LAYOUT** |
| 🟡 Current | `/catalog/new-category` **LAYOUT PASS** — ask before FIELDS — [`catalog_new_category_layout_compare.md`](modules/catalog_new_category_layout_compare.md) |
| ⬜ Pending | new-category FIELDS→COMPARE · other `/catalog/*` · Seq 7–8 / 11 purchase/receive/barcode |
...
| 2 | Dashboard | 🟡 nest COMPLETE · Catalog COMPARE · taxonomy COMPARE · new-category LAYOUT | [`catalog_new_category_layout_compare.md`](modules/catalog_new_category_layout_compare.md) · [`catalog_taxonomy_compare.md`](modules/catalog_taxonomy_compare.md) |
...
| 5 | Categories | 🟡 Backend Slice 1–2 · taxonomy COMPARE · new-category LAYOUT | [`catalog_new_category_layout_compare.md`](modules/catalog_new_category_layout_compare.md) · `docs/modules/categories.md` |
...
**Unlocked.** Phase 3 platform PASS. Dashboard nest COMPLETE. Catalog hub COMPARE PASS. Taxonomy COMPARE PASS. New-category LAYOUT PASS. Ask before FIELDS.
...
**4.2 / 4.5 note:** Dashboard nest COMPLETE. Catalog hub COMPARE — [`catalog_compare.md`](modules/catalog_compare.md). Taxonomy COMPARE — [`catalog_taxonomy_compare.md`](modules/catalog_taxonomy_compare.md). New-category LAYOUT — [`catalog_new_category_layout_compare.md`](modules/catalog_new_category_layout_compare.md). Ask before FIELDS. Settings hub skipped (implement locked).
...
---
*Last updated: 2026-07-25 — New-category LAYOUT PASS ([`catalog_new_category_layout_compare.md`](modules/catalog_new_category_layout_compare.md)); ask before FIELDS.*
