...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 `/home`+`/staff/home` COMPARE · `/home/activity` STATES | Next: activity COMPARE (Users & Roles UI blocked) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard `/home`+`/staff/home` COMPARE PASS. **`/home/activity` STATES** (current) → COMPARE next. Users & Roles UI blocked until users APIs.
...
| `/home/activity` | Nested under `/home` — **Step 6 STATES** |
