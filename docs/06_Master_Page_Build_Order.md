...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 nest COMPLETE · Catalog COMPARE · taxonomy COMPARE · new-category FIELDS | Ask before new-category BUTTONS — [`catalog_new_category_fields_compare.md`](modules/catalog_new_category_fields_compare.md) |
...
| 4 | Products/Catalog | 19 | ✅ `products.md`, `categories.md` | 🟡 Slice 1–7 · hub COMPARE · taxonomy COMPARE · new-category FIELDS | Ask before new-category BUTTONS — [`catalog_new_category_fields_compare.md`](modules/catalog_new_category_fields_compare.md) |
| 5 | Categories | 1 | ✅ `categories.md` | 🟡 Slice 1–2 · new-category FIELDS PASS | Next: new-category BUTTONS — [`catalog_new_category_fields_compare.md`](modules/catalog_new_category_fields_compare.md) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard nest **COMPLETE**. Products **Slice 1–7 PASS**. Categories **Slice 1–2 PASS**. Catalog hub **COMPARE PASS**. Taxonomy hub **COMPARE PASS**. New-category **FIELDS PASS**. Next: ask before **`/catalog/new-category` BUTTONS**. Purchase / barcode / receive **UI blocked** until their backends (docs/06 Seq 7–8 / 11).
...
| `/catalog/new-category` | **FIELDS PASS** — [`catalog_new_category_fields_compare.md`](modules/catalog_new_category_fields_compare.md) |
