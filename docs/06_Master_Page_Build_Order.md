...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 nest COMPLETE · Catalog COMPARE · taxonomy WIRE | Ask before taxonomy STATES — [`catalog_taxonomy_wire_compare.md`](modules/catalog_taxonomy_wire_compare.md) |
...
| 4 | Products/Catalog | 19 | ✅ `products.md`, `categories.md` | 🟡 Slice 1–7 · hub COMPARE · taxonomy WIRE | Ask before taxonomy STATES — [`catalog_taxonomy_wire_compare.md`](modules/catalog_taxonomy_wire_compare.md) |
| 5 | Categories | 1 | ✅ `categories.md` | 🟡 Slice 1–2 · taxonomy WIRE PASS | Next: taxonomy STATES — [`catalog_taxonomy_wire_compare.md`](modules/catalog_taxonomy_wire_compare.md) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard nest **COMPLETE**. Products **Slice 1–7 PASS**. Categories **Slice 1–2 PASS**. Catalog hub **COMPARE PASS**. Taxonomy hub **WIRE PASS**. Next: ask before **`/catalog/taxonomy` STATES**. Purchase / barcode / receive **UI blocked** until their backends (docs/06 Seq 7–8 / 11).
...
| `/catalog/taxonomy` | **WIRE PASS** — [`catalog_taxonomy_wire_compare.md`](modules/catalog_taxonomy_wire_compare.md) |
