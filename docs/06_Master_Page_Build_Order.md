...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 WIRE-2 DONE | Next: ask profile COMPARE **or** Subagent 4 ([`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md)) |
| 3 | Users & Roles | 2 | ✅ `users-roles.md` | 🟡 list COMPARE · profile STATES | COMPARE next — [`user_profile_states_compare.md`](modules/user_profile_states_compare.md) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard `/home`+`/staff/home`+`/home/activity`+`/home/breakdown-more` COMPARE PASS. Staff **WIRE-2a–2f COMPLETE**. Users backend **through bulk PASS**. Users list **COMPARE PASS**. Profile **STATES PASS**. Next: ask **profile COMPARE** or one **Subagent 4 satellite**.
...
| `/settings/users/:userId` | User profile — **STATES PASS** — [`user_profile_states_compare.md`](modules/user_profile_states_compare.md) |
