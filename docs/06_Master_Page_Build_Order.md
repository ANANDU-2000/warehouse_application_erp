...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard nest **COMPLETE**. Products **Slice 6 variants PASS**. Next: ask before **Products Slice 7**. Purchase / barcode / receive **UI blocked** until their backends (docs/06 Seq 7–8 / 11).
