...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 nest COMPLETE · Catalog COMPARE · taxonomy BUTTONS | Ask before taxonomy WIRE — [`catalog_taxonomy_buttons_compare.md`](modules/catalog_taxonomy_buttons_compare.md) |
...
| 4 | Products/Catalog | 19 | ✅ `products.md`, `categories.md` | 🟡 Slice 1–7 · hub COMPARE · taxonomy BUTTONS | Ask before taxonomy WIRE — [`catalog_taxonomy_buttons_compare.md`](modules/catalog_taxonomy_buttons_compare.md) |
| 5 | Categories | 1 | ✅ `categories.md` | 🟡 Slice 1–2 · taxonomy BUTTONS PASS | Next: taxonomy WIRE — [`catalog_taxonomy_buttons_compare.md`](modules/catalog_taxonomy_buttons_compare.md) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard nest **COMPLETE**. Products **Slice 1–7 PASS**. Categories **Slice 1–2 PASS**. Catalog hub **COMPARE PASS**. Taxonomy hub **BUTTONS PASS**. Next: ask before **`/catalog/taxonomy` WIRE**. Purchase / barcode / receive **UI blocked** until their backends (docs/06 Seq 7–8 / 11).
...
| `/catalog/taxonomy` | **BUTTONS PASS** — [`catalog_taxonomy_buttons_compare.md`](modules/catalog_taxonomy_buttons_compare.md) |
