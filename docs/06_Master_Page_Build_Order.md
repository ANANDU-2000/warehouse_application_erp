...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 `/home/breakdown-more` LAYOUT | Next: breakdown FIELDS (Users & Roles UI blocked) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard `/home`+`/staff/home`+`/home/activity` COMPARE PASS. **`/home/breakdown-more` LAYOUT** (current) → FIELDS next. Users & Roles UI blocked until users APIs.
...
| `/home/breakdown-more` | Nested under `/home` — **Step 2 LAYOUT** |
