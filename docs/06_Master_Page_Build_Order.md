...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 WIRE-2 DONE | Next: ask Users BUTTONS **or** Subagent 4 ([`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md)) |
| 3 | Users & Roles | 2 | ✅ `users-roles.md` | 🟡 backend PASS · UI FIELDS | BUTTONS next — [`users_management_fields_compare.md`](modules/users_management_fields_compare.md) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard `/home`+`/staff/home`+`/home/activity`+`/home/breakdown-more` COMPARE PASS. Staff **WIRE-2a–2f COMPLETE**. Users backend **through bulk PASS**. Users UI **FIELDS PASS**. Next: ask **Users BUTTONS** or one **Subagent 4 satellite**.
