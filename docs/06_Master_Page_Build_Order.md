...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 `/home`+`/staff/home` COMPARE · `/home/activity` BUTTONS | Next: activity WIRE (Users & Roles UI blocked) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard `/home`+`/staff/home` COMPARE PASS. **`/home/activity` BUTTONS** (current) → WIRE next. Users & Roles UI blocked until users APIs.
...
| `/home/activity` | Nested under `/home` — **Step 4 BUTTONS** |
