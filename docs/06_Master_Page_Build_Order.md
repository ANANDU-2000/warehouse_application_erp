...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 WIRE-2 DONE | Next: ask profile SCAFFOLD **or** Subagent 4 ([`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md)) |
| 3 | Users & Roles | 2 | ✅ `users-roles.md` | 🟡 backend PASS · list UI COMPARE | Profile next — [`users_management_compare.md`](modules/users_management_compare.md) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard `/home`+`/staff/home`+`/home/activity`+`/home/breakdown-more` COMPARE PASS. Staff **WIRE-2a–2f COMPLETE**. Users backend **through bulk PASS**. Users list UI **COMPARE PASS**. Next: ask **profile SCAFFOLD** or one **Subagent 4 satellite**.
...
| `/settings/users/:userId` | User profile stub route (page body deferred — ask before SCAFFOLD) |
