...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 WIRE-2 · Staff activity SCAFFOLD | Next: ask before LAYOUT — [`staff_activity_scaffold_compare.md`](modules/staff_activity_scaffold_compare.md) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard `/home`+`/staff/home`+`/home/activity`+`/home/breakdown-more` COMPARE PASS. Staff **WIRE-2a–2f COMPLETE**. Users list+profile **COMPARE PASS**. Profile Activity **WIRE PASS**. Subagent 4: `/notifications` **COMPARE PASS**. Staff search **COMPARE PASS**. Staff items **COMPARE PASS**. Staff stock **COMPARE PASS**. Staff purchase-history **COMPARE PASS**. Staff low-stock **COMPARE PASS**. Staff activity **SCAFFOLD PASS**. Next: ask before **LAYOUT**. Purchase entry / barcode / receive **backend-blocked** (docs/06 Seq 7–8 / 11).
...
| `/staff/activity` | Staff shell — **SCAFFOLD PASS** — [`staff_activity_scaffold_compare.md`](modules/staff_activity_scaffold_compare.md) |
