...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 WIRE-2 DONE | Next: ask Users UI **or** Subagent 4 ([`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md)) |
| 3 | Users & Roles | 2 | ✅ `users-roles.md` | 🟡 through ledger PASS | UI blocked — [`users_roles_backend_ledger_compare.md`](modules/users_roles_backend_ledger_compare.md) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard `/home`+`/staff/home`+`/home/activity`+`/home/breakdown-more` COMPARE PASS. Staff **WIRE-2a–2f COMPLETE**. Users **through ledger PASS**. Next: ask **Users UI** or one **Subagent 4 satellite**. Users UI blocked until enough users APIs.
