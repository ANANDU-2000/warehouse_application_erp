...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 WIRE-2 · Staff low-stock SCAFFOLD | Next: ask before LAYOUT — [`staff_low_stock_scaffold_compare.md`](modules/staff_low_stock_scaffold_compare.md) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard `/home`+`/staff/home`+`/home/activity`+`/home/breakdown-more` COMPARE PASS. Staff **WIRE-2a–2f COMPLETE**. Users list+profile **COMPARE PASS**. Profile Activity **WIRE PASS**. Subagent 4: `/notifications` **COMPARE PASS**. Staff search **COMPARE PASS**. Staff items **COMPARE PASS**. Staff stock **COMPARE PASS**. Staff purchase-history **COMPARE PASS**. Staff low-stock **SCAFFOLD PASS**. Next: ask before **LAYOUT**.
...
| `/staff/low-stock` | Staff shell — **SCAFFOLD PASS** — [`staff_low_stock_scaffold_compare.md`](modules/staff_low_stock_scaffold_compare.md) |
