...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 WIRE-2 DONE | Next: ask Users UI / satellites **or** Subagent 4 ([`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md)) |
| 3 | Users & Roles | 2 | ✅ `users-roles.md` | 🟡 through permissions PASS | UI/satellites blocked — [`users_roles_backend_permissions_compare.md`](modules/users_roles_backend_permissions_compare.md) |
