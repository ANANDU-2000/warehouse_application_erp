...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 `/home/breakdown-more` WIRE | Next: breakdown STATES (Users & Roles UI blocked) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard `/home`+`/staff/home`+`/home/activity` COMPARE PASS. **`/home/breakdown-more` WIRE** (current) → STATES next. Users & Roles UI blocked until users APIs.
...
| `/home/breakdown-more` | Nested under `/home` — **Step 5 WIRE** |
