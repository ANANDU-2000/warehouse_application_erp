...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 `/home`+`/staff/home`+`/home/activity` COMPARE | Next: `/home/breakdown-more` SCAFFOLD (Users & Roles UI blocked) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard `/home`+`/staff/home`+`/home/activity` COMPARE PASS. **`/home/breakdown-more` SCAFFOLD** (current). Users & Roles UI blocked until users APIs.
...
| `/home/breakdown-more` | Nested under `/home` — **Step 1 SCAFFOLD next** |
