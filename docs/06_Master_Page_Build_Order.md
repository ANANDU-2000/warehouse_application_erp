...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 nest COMPLETE · Catalog COMPARE · taxonomy COMPARE | Ask before new-category SCAFFOLD — [`catalog_taxonomy_compare.md`](modules/catalog_taxonomy_compare.md) |
...
| 4 | Products/Catalog | 19 | ✅ `products.md`, `categories.md` | 🟡 Slice 1–7 · hub COMPARE · taxonomy COMPARE | Ask before new-category SCAFFOLD — [`catalog_taxonomy_compare.md`](modules/catalog_taxonomy_compare.md) |
| 5 | Categories | 1 | ✅ `categories.md` | 🟡 Slice 1–2 · taxonomy COMPARE PASS | Next: `/catalog/new-category` SCAFFOLD — [`catalog_taxonomy_compare.md`](modules/catalog_taxonomy_compare.md) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard nest **COMPLETE**. Products **Slice 1–7 PASS**. Categories **Slice 1–2 PASS**. Catalog hub **COMPARE PASS**. Taxonomy hub **COMPARE PASS**. Next: ask before **`/catalog/new-category` SCAFFOLD**. Purchase / barcode / receive **UI blocked** until their backends (docs/06 Seq 7–8 / 11).
