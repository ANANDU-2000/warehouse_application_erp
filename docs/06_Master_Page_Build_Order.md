...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 WIRE-2 DONE | Next: ask profile LAYOUT **or** Subagent 4 ([`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md)) |
| 3 | Users & Roles | 2 | ✅ `users-roles.md` | 🟡 list COMPARE · profile SCAFFOLD | LAYOUT next — [`user_profile_scaffold_compare.md`](modules/user_profile_scaffold_compare.md) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard `/home`+`/staff/home`+`/home/activity`+`/home/breakdown-more` COMPARE PASS. Staff **WIRE-2a–2f COMPLETE**. Users backend **through bulk PASS**. Users list **COMPARE PASS**. Profile **SCAFFOLD PASS**. Next: ask **profile LAYOUT** or one **Subagent 4 satellite**.
...
| `/settings/users/:userId` | User profile — **SCAFFOLD PASS** — [`user_profile_scaffold_compare.md`](modules/user_profile_scaffold_compare.md) |
