...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 WIRE-2 DONE | Next: ask profile STATES **or** Subagent 4 ([`dashboard_subagent4_inventory.md`](modules/dashboard_subagent4_inventory.md)) |
| 3 | Users & Roles | 2 | ✅ `users-roles.md` | 🟡 list COMPARE · profile WIRE | STATES next — [`user_profile_wire_compare.md`](modules/user_profile_wire_compare.md) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard `/home`+`/staff/home`+`/home/activity`+`/home/breakdown-more` COMPARE PASS. Staff **WIRE-2a–2f COMPLETE**. Users backend **through bulk PASS**. Users list **COMPARE PASS**. Profile **WIRE PASS**. Next: ask **profile STATES** or one **Subagent 4 satellite**.
...
| `/settings/users/:userId` | User profile — **WIRE PASS** — [`user_profile_wire_compare.md`](modules/user_profile_wire_compare.md) |
