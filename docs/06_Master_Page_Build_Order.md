...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 staff WIRE-2a PASS | Next: ask WIRE-2b pending cards (Users & Roles UI blocked) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard `/home`+`/staff/home`+`/home/activity`+`/home/breakdown-more` COMPARE PASS. Staff **WIRE-2a** PASS → ask **WIRE-2b**. Users & Roles UI blocked until users APIs.
...
| `/staff/home` | **COMPARE PASS** + **WIRE-2a** warehouse stats |
