...
| 2 | Dashboard/Home | 2+ | ✅ `dashboard.md` | 🟡 nest COMPLETE · Catalog WIRE | Catalog WIRE — [`catalog_wire_compare.md`](modules/catalog_wire_compare.md) |
...
| 4 | Products/Catalog | 19 | ✅ `products.md`, `categories.md` | 🟡 Slice 1–7 · hub WIRE | Ask before STATES — [`catalog_wire_compare.md`](modules/catalog_wire_compare.md) |
| 5 | Categories | 1 | ✅ `categories.md` | 🟡 Slice 1–2 · hub UI WIRE | Backend PASS — [`categories_backend_slice2.md`](modules/categories_backend_slice2.md) |
...
Login UI: **COMPARE PASS**. Splash: **7 COMPARE PASS**. Dashboard nest **COMPLETE**. Products **Slice 1–7 PASS**. Categories **Slice 1–2 PASS**. Catalog hub **WIRE PASS**. Next: ask before **Catalog STATES**. Purchase / barcode / receive **UI blocked** until their backends (docs/06 Seq 7–8 / 11).
