...
| State | Step |
|---|---|
| ✅ Completed | Products Slice 1–7 · Categories Slice 1–2 · Catalog hub **SCAFFOLD→COMPARE** · taxonomy SCAFFOLD→…→**BUTTONS** |
| 🟡 Current | `/catalog/taxonomy` **BUTTONS PASS** — ask before WIRE |
| ⬜ Pending | taxonomy WIRE→COMPARE · `/catalog/new-category` · category detail · item routes · trade-summary |
...
| Item | Why deferred |
|---|---|
| `/catalog/taxonomy` body | **BUTTONS done** — WIRE next ([`catalog_taxonomy_buttons_compare.md`](catalog_taxonomy_buttons_compare.md)) |
