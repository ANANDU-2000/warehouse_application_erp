...
| State | Step |
|---|---|
| ✅ Completed | Products Slice 1–7 · Categories Slice 1–2 · Catalog hub **SCAFFOLD→COMPARE** · taxonomy SCAFFOLD→…→**WIRE** |
| 🟡 Current | `/catalog/taxonomy` **WIRE PASS** — ask before STATES |
| ⬜ Pending | taxonomy STATES→COMPARE · `/catalog/new-category` · category detail · item routes · trade-summary |
...
| Item | Why deferred |
|---|---|
| `/catalog/taxonomy` body | **WIRE done** — STATES next ([`catalog_taxonomy_wire_compare.md`](catalog_taxonomy_wire_compare.md)) |
