...
| State | Step |
|---|---|
| ✅ Completed | Products Slice 1–7 · Categories Slice 1–2 · Catalog hub **SCAFFOLD→COMPARE** · taxonomy **SCAFFOLD→COMPARE** |
...
| Item | Why deferred |
|---|---|
| `/catalog/taxonomy` body | **COMPARE PASS** — [`catalog_taxonomy_compare.md`](catalog_taxonomy_compare.md) |
