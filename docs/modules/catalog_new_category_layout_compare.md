...
| 🟡 Current | superseded — see [`catalog_new_category_fields_compare.md`](catalog_new_category_fields_compare.md) |
...
**Next (ask first):** FIELDS — done → [`catalog_new_category_fields_compare.md`](catalog_new_category_fields_compare.md). Ask before BUTTONS.
