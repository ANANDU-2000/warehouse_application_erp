...
| State | Step |
|---|---|
| ✅ Completed | Products Slice 1–7 · Categories Slice 1–2 · Catalog hub COMPARE · taxonomy **SCAFFOLD→COMPARE** · new-category SCAFFOLD→**LAYOUT** |
| 🟡 Current | `/catalog/new-category` **LAYOUT PASS** — ask before FIELDS |
| ⬜ Pending | new-category FIELDS→COMPARE · category detail · item routes · trade-summary |
...
| `/catalog/new-category` · category detail bodies | **new-category LAYOUT done** — FIELDS next ([`catalog_new_category_layout_compare.md`](catalog_new_category_layout_compare.md)) |
