...
| 🟡 Current | See [`catalog_new_subcategory_buttons_compare.md`](catalog_new_subcategory_buttons_compare.md) |
| ⬜ Pending | new-subcategory WIRE→COMPARE · trade-summary · other catalog routes |
