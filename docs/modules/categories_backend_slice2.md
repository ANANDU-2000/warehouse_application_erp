...
| 🟡 Current | See [`catalog_new_category_wire_compare.md`](catalog_new_category_wire_compare.md) |
| ⬜ Pending | new-category STATES→COMPARE · trade-summary · other catalog routes |
