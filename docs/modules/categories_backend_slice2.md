...
| 🟡 Current | See [`catalog_new_subcategory_scaffold_compare.md`](catalog_new_subcategory_scaffold_compare.md) |
| ⬜ Pending | new-subcategory LAYOUT→COMPARE · trade-summary · other catalog routes |
