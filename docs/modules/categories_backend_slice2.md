...
| 🟡 Current | See [`catalog_new_category_layout_compare.md`](catalog_new_category_layout_compare.md) |
| ⬜ Pending | new-category FIELDS→COMPARE · trade-summary · other catalog routes |
