...
| 🟡 Current | See [`catalog_new_category_buttons_compare.md`](catalog_new_category_buttons_compare.md) |
| ⬜ Pending | new-category WIRE→COMPARE · trade-summary · other catalog routes |
