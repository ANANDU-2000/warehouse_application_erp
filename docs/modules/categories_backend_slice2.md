...
| 🟡 Current | See [`catalog_new_category_states_compare.md`](catalog_new_category_states_compare.md) |
| ⬜ Pending | new-category COMPARE · trade-summary · other catalog routes |
