...
| 🟡 Current | See [`catalog_new_category_fields_compare.md`](catalog_new_category_fields_compare.md) |
| ⬜ Pending | new-category BUTTONS→COMPARE · trade-summary · other catalog routes |
