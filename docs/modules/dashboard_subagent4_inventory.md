...
1. **Products Slice 4** — fuzzy-check / variants / code patches (ask first), **or**  
...
*(Staff deliveries COMPARE — [`staff_deliveries_compare.md`](staff_deliveries_compare.md). Products Slice 3 — [`products_backend_slice3.md`](products_backend_slice3.md). `/staff/settings` skipped — Settings implement locked.)*
