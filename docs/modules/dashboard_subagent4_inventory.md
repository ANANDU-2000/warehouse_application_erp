...
1. **Products Slice 5** — variants / item-code/barcode patches / bulk-archive (ask first), **or**  
...
*(Staff deliveries COMPARE — [`staff_deliveries_compare.md`](staff_deliveries_compare.md). Products Slice 4 — [`products_backend_slice4.md`](products_backend_slice4.md). `/staff/settings` skipped — Settings implement locked.)*
