...
| `/staff/purchase-history` | **BUTTONS PASS** — [`staff_purchase_history_buttons_compare.md`](staff_purchase_history_buttons_compare.md); ask before WIRE |
