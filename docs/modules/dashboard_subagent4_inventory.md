...
| Path | Blocker |
|---|---|
| `/settings/users` · `/settings/users/:userId` | List+create+profile+PATCH+DELETE APIs exist; reset/permissions / UI still pending |
...
1. **Users stock-adjustments / purchases / ledger / Users UI**, or  
