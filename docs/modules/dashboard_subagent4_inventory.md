...
| `/staff/search` | **FIELDS PASS** — [`staff_search_fields_compare.md`](staff_search_fields_compare.md); ask before BUTTONS |
...
1. **`/staff/search` BUTTONS** (FIELDS done), **or**  
2. Hold / merge review of `ops/dashboard-module` → `main`.

*(Notifications COMPARE done — [`notifications_compare.md`](notifications_compare.md). Staff search FIELDS — [`staff_search_fields_compare.md`](staff_search_fields_compare.md). `/staff/settings` skipped — Settings implement locked.)*
