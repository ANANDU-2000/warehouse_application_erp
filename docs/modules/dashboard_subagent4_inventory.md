...
1. **`/catalog/category/:id/new-subcategory` SCAFFOLD** — page loop step 1, **or**  
...
*(New-category COMPARE PASS — [`catalog_new_category_compare.md`](catalog_new_category_compare.md).)*
