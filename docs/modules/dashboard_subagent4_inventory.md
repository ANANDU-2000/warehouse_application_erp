...
| `/staff/purchase-history` | **LAYOUT PASS** — [`staff_purchase_history_layout_compare.md`](staff_purchase_history_layout_compare.md); ask before FIELDS |
