...
1. **`/catalog/category/:categoryId/new-subcategory` WIRE** — page loop step 5, **or**  
...
*(New-subcategory BUTTONS PASS — [`catalog_new_subcategory_buttons_compare.md`](catalog_new_subcategory_buttons_compare.md).)*
