...
| 🟡 Current | `/home/breakdown-more` route loop **PASS** — staff WIRE-2d PASS; ask notifications / Subagent 4 |
| ⬜ Pending | notifications · pull-refresh · Users & Roles (backend blocked) |
