...
| State | Step |
|---|---|
| ✅ Completed | Slice 1–3 · **Slice 4 fuzzy-check** |
| 🟡 Current | Products backend Slice 4 PASS — ask before Slice 5 (variants / item-code/barcode patches / bulk-archive) or catalog UI |
