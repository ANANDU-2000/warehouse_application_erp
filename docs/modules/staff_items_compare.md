...
| ⬜ Pending (ask first) | Staff stock LAYOUT → COMPARE · other Subagent 4 stubs |
...
1. Ask before: **`/staff/stock` LAYOUT** (SCAFFOLD done — [`staff_stock_scaffold_compare.md`](staff_stock_scaffold_compare.md)), **or**  
