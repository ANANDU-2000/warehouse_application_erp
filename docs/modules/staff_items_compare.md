...
| ⬜ Pending (ask first) | Staff stock WIRE → COMPARE · other Subagent 4 stubs |
...
1. Ask before: **`/staff/stock` WIRE** (BUTTONS done — [`staff_stock_buttons_compare.md`](staff_stock_buttons_compare.md)), **or**  
