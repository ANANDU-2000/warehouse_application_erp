...
| State | Step |
|---|---|
| ✅ Completed | Notifications COMPARE · Staff search SCAFFOLD→COMPARE · Staff items **SCAFFOLD** |
| 🟡 Current | Staff items **SCAFFOLD PASS** — ask before LAYOUT |
| ⬜ Pending | Staff items LAYOUT → COMPARE · other Subagent 4 stubs |
...
**Next (ask first):** `/staff/items` LAYOUT — do not start until approved.
