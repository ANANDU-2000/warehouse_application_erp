...
**Queue:** 3 of 15  
**Status:** Backend Slice 1–14 PASS · list UI COMPARE PASS · profile WIRE PASS (2026-07-19) · STATES pending  
**Scope:** Analysis + users admin APIs + bulk; list UI through COMPARE; profile page-loop through WIRE  
**Source of truth:** `source-app/`  
**Compare:** backend `users_roles_backend_*` · list [`users_management_compare.md`](users_management_compare.md) · profile [`user_profile_wire_compare.md`](user_profile_wire_compare.md)
