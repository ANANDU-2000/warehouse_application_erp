...
| 🟡 Current | Users list UI **COMPARE PASS** — ask before profile SCAFFOLD **or** Subagent 4 |
| ⬜ Pending (ask first) | Profile `/settings/users/:userId` page loop · Subagent 4 — [`dashboard_subagent4_inventory.md`](dashboard_subagent4_inventory.md) |
...
1. Ask before: **User profile** `/settings/users/:userId` SCAFFOLD, **or**  
