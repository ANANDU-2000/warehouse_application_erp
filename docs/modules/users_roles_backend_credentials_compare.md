...
| 8 | permissions / UI | Out of slice | See Slice 8 | N/A |
...
**Next:** Slice 8 permissions — [`users_roles_backend_permissions_compare.md`](users_roles_backend_permissions_compare.md).
