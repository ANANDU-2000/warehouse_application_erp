...
assert(home.includes('data-slot="alerts"'), "alerts slot");
assert(home.includes('data-slot="kpi-grid"'), "kpi slot");
assert(home.includes('data-slot="delivery"'), "delivery slot");
assert(home.includes('data-slot="purchase-center"'), "purchase slot");
assert(home.includes('data-slot="tools"'), "tools slot");
assert(home.includes('data-slot="activity"'), "activity slot");
...
assert(css.includes("#f5f7f6") || css.includes("#F5F7F6"), "scaffold bg");
